...
class Event(models.Model):
    ...
    # author      = models.ForeignKey('coop_local.Membre',blank=True,null=True,verbose_name=_('author'))
    # location    = models.ForeignKey(Location,blank=True,null=True,verbose_name=_('location'))
    #     
    # organization_uri = models.CharField(blank=True, max_length=250,verbose_name=_('organization URI'))
    # author_uri = models.CharField(blank=True, max_length=250,verbose_name=_('author URI'))
